...
-- Create new table for retiring employees by joining the "retirement_info" and "dept_emp" tables
...
-- Join the "retirement_info" and "dept_emp" tables to make sure they're still employed using left join
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
de.to_date
